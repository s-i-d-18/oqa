...
function RatingsInfo({ display, show }){



    return(
        <>
            <div className="text-[#c5c5c5]  bg-[#212121] w-full h-full py-3 rounded-2xl border-[1px] border-[#565656]">

            {
                display.map((item, index) =>(
                    ...
                    {(index!=(display.length)-1) &&
                        ...
                        <div className="h-[0.3px] w-[95%] bg-white/50">
